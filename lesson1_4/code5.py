...
data - ссылка на список из числовых данных;
...
class Graph:
    def __init__(self, data: list or tuple, is_show: True) -> None:
        self.data = data
        self.is_show = is_show

    def set_data(self, data: list or tuple):
        self.data = data

    def show_table(self):
        if self.is_show == True:
            print(f"{' '.join(str(x) for x in self.data)}")
        else:
    ...
    def show_graph(self):
        if self.is_show == True:
            print(
                f"Графическое отображение данных: {' '.join(str(x) for x in self.data)}")
        else:
            print("Отображение данных закрыто")
    ...
    def show_bar(self):
        if self.is_show == True:
            print(
                f"Столбчатая диаграмма: {' '.join(str(x) for x in self.data)}")
        else:
            print("Отображение данных закрыто")
